ChocTops = {
    ...
    "PartA":[5,26,3],
    "PartB":[3,"Sam James",2,"Sam James",1,"Ryan Pattemore",1,"William Kim"],
    "PartC":[6.5,3,2.5,0.5,2.5,13],
    "PartD":[3,9,25,2,9,18.2],              
    "Date": [],
    "Wins": [],
    "Losses": [],
    "Points": [],
...
TrafficControllers = {
    ...
    "PartA":[9,17,3],
    "PartB":[4,"Clarrie Jones",1,"Clarrie Jones",4,"Samuel McConaghy",1,"Clarrie Jones"],
    "PartC":[11.5,6.5,2,1.5,4.5,8.5],
    "PartD":[9,3,75,10,9,52.6],                    
    "Date": [],
    "Wins": [],
    "Losses": [],
    "Points": [],
